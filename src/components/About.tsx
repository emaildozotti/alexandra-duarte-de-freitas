...
const COPY = {
  eyebrow: 'sobre mim',
  heading: 'Eu sei o que é se sentir',
  headingEm: 'abandonada.',
  paragraphs: [
    'Antes de ser psicóloga, eu fui alguém que carregava uma dor intensa na alma. A sensação de abandono, as dificuldades nos relacionamentos, a impressão de estar perdida na vida adulta. Eu procurei ajuda e encontrei consultórios apressados, sessões de 50 minutos onde o relógio parecia mais importante que a minha dor.',
    'Foi ali que eu decidi: vou atender o outro exatamente como eu gostaria de ter sido atendida quando mais precisei. Essa é a minha regra de ouro.',
    'Hoje eu ofereço o que não recebi: tempo, presença e ferramentas práticas. Minhas sessões são estendidas porque a dor precisa de espaço. E cada paciente sai com exercícios concretos para continuar a transformação entre os encontros.',
  ],
  transition: 'Quer saber como o seu processo funcionaria na prática?',
